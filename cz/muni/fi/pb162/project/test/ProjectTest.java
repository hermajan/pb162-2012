...
public class ProjectTest extends AbstractTest {
    ...
    @Test public void task01() {
        ...
        assertEquals("getColor()", "white", pol.getColor());
        pol.setColor("black");
        assertEquals("setColor()", "black", pol.getColor());
        assertEquals("toString()", "8-gon: center=[1.0, -1.0], edge length=2.0, color=black", pol.toString());
